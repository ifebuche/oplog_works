...
class TestLoader(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.loader = Loader(cls.mongo_client, cls.final, datalake=False, datawarehouse=True, aws={})
    ...
    def test_loader_new_row(self):
        ...
        self.loader = Loader(self.mongo_client, self.final, datalake=False, datawarehouse=True, aws={})
        self.loader.run(warehouse=True, host=os.getenv("host"), user=os.getenv("user"),
                        password=os.getenv("password"), db=os.getenv("db"), port=5432)
